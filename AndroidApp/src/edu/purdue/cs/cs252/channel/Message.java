...
class Message {
    ...
    public enum Type {
        ...
        Added, // server response to a new client (message content should
               // include an ID)
     ...
     * 
     * @param messageString
     *            The whole received message string including the type and not
     *            the value only.
     */
    ...
    public void logPrint(boolean isSend) {
        System.err.println((isSend ? "o$" : "i$") + this.channelID + "$"
                + this.value);
    }
}
