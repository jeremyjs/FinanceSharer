...
public abstract class Channel {
     ...
     */
    protected final HashMap<Integer, ArrayList<Message>> pendingMessages = new HashMap<Integer, ArrayList<Message>>();
     ...
     * 
     * @return the channel ID (a value >= 0 if this is a client channel, -1 for
     *         a server channel).
     */
    public int getID() {
        return channelID;
    ...
    public void sendMessage(String message) throws ChannelException {
        assert (message != null);
        sendMessage(new Message(Message.Type.NewMessage, message,
                this.channelID));
    }
    ...
    /**
     * Returns a pending message, if available; otherwise, return a Message of
     * {@link Message.Type} NoMessage.
     * 
     * @param message
    ...
    private Message checkMessageReceived(Message message) {
        assert (message != null);
        ArrayList<Message> messageList = pendingMessages.get(message
                .getChannelID());
    ...
    protected Message messageReceived(Message message) throws ChannelException {
        ...
        case MessageReceived:
            ...
            this.messageListener.messageReceived(message.getValue(),
        ...
        case NewMessage:
            ...
            // Invoke the messageReceived from the listener and send an ack
            // reply...
            this.messageListener.messageReceived(message.getValue(),
                    message.getChannelID());
        ...
        case Acknowledge:
            ...
            break;
        default:
            throw new ChannelException("Invalid message type received: "
                    + message.getType());
        }
        return null;
    }
